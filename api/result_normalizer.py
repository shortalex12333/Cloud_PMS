...
USAGE:
    from api.result_normalizer import normalize_results
...
from api.table_capabilities import TABLE_CAPABILITIES, Capability
from api.capability_executor import QueryResult
