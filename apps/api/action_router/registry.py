...
ACTION_REGISTRY: Dict[str, ActionDefinition] = {
    ...
    "add_to_handover": ActionDefinition(
        ...
        schema_file=None,
        field_metadata=[
            FieldMetadata("entity_id", FieldClassification.BACKEND_AUTO,
                          auto_populate_from="entity",
                          description="Source entity UUID — auto-populated from context"),
            FieldMetadata("title", FieldClassification.BACKEND_AUTO,
                          auto_populate_from="entity",
                          description="Entity title — auto-populated from context"),
            FieldMetadata("summary", FieldClassification.REQUIRED,
                          description="What the incoming shift needs to know about this item"),
            FieldMetadata("section", FieldClassification.OPTIONAL,
                          options=["Engineering", "Deck", "Interior", "Command", "Bridge"],
                          description="Handover section to file this under"),
            FieldMetadata("notes", FieldClassification.OPTIONAL,
                          description="Additional context or instructions for the incoming watch"),
        ],
    ),
    ...
    "report_fault": ActionDefinition(
        ...
        field_metadata=[
            ...
            FieldMetadata("detected_at", FieldClassification.OPTIONAL,
                          description="When the fault was first detected"),
            FieldMetadata("fault_code", FieldClassification.OPTIONAL,
                          description="Fault reference code (auto-generated if blank)"),
        ],
    ),
    ...
    "adjust_receiving_item": ActionDefinition(
        ...
        field_metadata=[
            ...
            FieldMetadata("quantity_accepted", FieldClassification.OPTIONAL, description="Crew's accepted count (<= quantity_received)"),
            FieldMetadata("quantity_rejected", FieldClassification.OPTIONAL, description="Crew's rejected count (damaged/short/wrong)"),
            FieldMetadata("disposition", FieldClassification.OPTIONAL, description="Per-line state: pending|accepted|short|damaged|wrong_item|over"),
    ...
    "update_certificate": ActionDefinition(
        ...
        field_metadata=[
            FieldMetadata("certificate_name",   FieldClassification.OPTIONAL, description="Certificate Name"),
            FieldMetadata("certificate_number", FieldClassification.OPTIONAL, description="Certificate Number"),
            FieldMetadata("issuing_authority",  FieldClassification.OPTIONAL, description="Issuing Authority"),
            FieldMetadata("issue_date",         FieldClassification.OPTIONAL, description="Issue Date"),
            FieldMetadata("expiry_date",        FieldClassification.OPTIONAL, description="Expiry Date"),
            FieldMetadata("last_survey_date",   FieldClassification.OPTIONAL, description="Last Survey Date (vessel only)"),
            FieldMetadata("next_survey_due",    FieldClassification.OPTIONAL, description="Next Survey Due (vessel only)"),
        ],
        schema_file=None,
        domain="certificates",
        variant=ActionVariant.MUTATE,
    ...
    # ========================================================================
    # SHOPPING LIST LENS ACTIONS (v2) — document-level
    # ========================================================================
    # Domain: shopping_list (shared with v1)
    # Tables: pms_shopping_lists (header) + pms_shopping_list_items (children)
    # Handlers: apps/api/handlers/shopping_list_v2_handlers.py
    # ========================================================================

    "create_shopping_list": ActionDefinition(
        action_id="create_shopping_list",
        label="Create Shopping List",
        endpoint="/v1/actions/execute",
        handler_type=HandlerType.INTERNAL,
        method="POST",
        allowed_roles=["crew", "deckhand", "bosun", "eto", "chief_engineer", "chief_officer", "captain", "manager"],
        required_fields=["yacht_id", "name"],
        domain="shopping_list",
        variant=ActionVariant.MUTATE,
        search_keywords=["create", "shopping", "list", "new", "requisition"],
        field_metadata=[
            FieldMetadata("yacht_id", FieldClassification.CONTEXT),
            FieldMetadata("name", FieldClassification.REQUIRED, description="Name for this shopping list (e.g. 'Engine Stores Run')"),
            FieldMetadata("department", FieldClassification.OPTIONAL,
                          options=["engine", "deck", "galley", "interior", "bridge", "general"],
                          description="Department for this list"),
            FieldMetadata("currency", FieldClassification.OPTIONAL, description="Currency code (default EUR)"),
            FieldMetadata("notes", FieldClassification.OPTIONAL),
        ],
    ),

    "add_item_to_list": ActionDefinition(
        action_id="add_item_to_list",
        label="Add Item to List",
        endpoint="/v1/actions/execute",
        handler_type=HandlerType.INTERNAL,
        method="POST",
        allowed_roles=["crew", "deckhand", "bosun", "eto", "chief_engineer", "chief_officer", "captain", "manager"],
        required_fields=["yacht_id", "shopping_list_id", "part_name", "quantity_requested"],
        domain="shopping_list",
        variant=ActionVariant.MUTATE,
        search_keywords=["add", "item", "shopping", "list", "request"],
        field_metadata=[
            FieldMetadata("yacht_id", FieldClassification.CONTEXT),
            FieldMetadata("shopping_list_id", FieldClassification.REQUIRED, description="Parent shopping list ID"),
            FieldMetadata("part_name", FieldClassification.REQUIRED, description="Name of part/item needed"),
            FieldMetadata("quantity_requested", FieldClassification.REQUIRED, description="Amount requested (must be > 0)"),
            FieldMetadata("part_id", FieldClassification.OPTIONAL, description="Link to existing part in catalog"),
            FieldMetadata("part_number", FieldClassification.OPTIONAL),
            FieldMetadata("manufacturer", FieldClassification.OPTIONAL),
            FieldMetadata("unit", FieldClassification.OPTIONAL),
            FieldMetadata("unit_price", FieldClassification.OPTIONAL, description="Estimated unit price"),
            FieldMetadata("source_url", FieldClassification.OPTIONAL, description="Supplier URL"),
            FieldMetadata("storage_location", FieldClassification.OPTIONAL),
            FieldMetadata("department", FieldClassification.OPTIONAL),
            FieldMetadata("notes", FieldClassification.OPTIONAL),
            FieldMetadata("is_candidate_part", FieldClassification.OPTIONAL),
            FieldMetadata("source_type", FieldClassification.OPTIONAL,
                          options=["inventory_low", "inventory_oos", "work_order_usage", "manual_add"]),
        ],
    ),

    "update_list_item": ActionDefinition(
        action_id="update_list_item",
        ...
        domain="shopping_list",
        variant=ActionVariant.MUTATE,
        search_keywords=["update", "edit", "item", "shopping", "list", "change", "quantity"],
        field_metadata=[
            FieldMetadata("yacht_id", FieldClassification.CONTEXT),
            FieldMetadata("item_id", FieldClassification.REQUIRED, description="Shopping list item ID"),
            FieldMetadata("quantity_requested", FieldClassification.OPTIONAL),
            FieldMetadata("unit_price", FieldClassification.OPTIONAL),
            FieldMetadata("source_url", FieldClassification.OPTIONAL),
            FieldMetadata("storage_location", FieldClassification.OPTIONAL),
            FieldMetadata("notes", FieldClassification.OPTIONAL),
        ],
    ),

    "delete_list_item": ActionDefinition(
        action_id="delete_list_item",
        ...
        domain="shopping_list",
        variant=ActionVariant.MUTATE,
        search_keywords=["delete", "remove", "item", "shopping", "list"],
        field_metadata=[
            FieldMetadata("yacht_id", FieldClassification.CONTEXT),
            FieldMetadata("item_id", FieldClassification.REQUIRED, description="Shopping list item ID to delete"),
        ],
    ),

    "submit_shopping_list": ActionDefinition(
        action_id="submit_shopping_list",
        label="Submit for HOD Review",
        endpoint="/v1/actions/execute",
        handler_type=HandlerType.INTERNAL,
        method="POST",
        allowed_roles=["crew", "deckhand", "bosun", "eto", "chief_engineer", "chief_officer", "captain", "manager"],
        required_fields=["yacht_id", "shopping_list_id"],
        domain="shopping_list",
        variant=ActionVariant.MUTATE,
        search_keywords=["submit", "shopping", "list", "hod", "review", "approve"],
        field_metadata=[
            FieldMetadata("yacht_id", FieldClassification.CONTEXT),
            FieldMetadata("shopping_list_id", FieldClassification.REQUIRED, description="Shopping list to submit"),
        ],
    ),

    "hod_review_list_item": ActionDefinition(
        action_id="hod_review_list_item",
        label="Review Line Item",
        endpoint="/v1/actions/execute",
        handler_type=HandlerType.INTERNAL,
        method="POST",
        allowed_roles=["chief_engineer", "chief_officer", "captain", "manager"],
        required_fields=["yacht_id", "item_id", "decision"],
        domain="shopping_list",
        variant=ActionVariant.MUTATE,
        search_keywords=["hod", "review", "approve", "reject", "line", "item"],
        field_metadata=[
            FieldMetadata("yacht_id", FieldClassification.CONTEXT),
            FieldMetadata("item_id", FieldClassification.REQUIRED, description="Shopping list item ID"),
            FieldMetadata("decision", FieldClassification.REQUIRED, options=["approved", "rejected"],
                          description="HOD decision on this line item"),
            FieldMetadata("quantity_approved", FieldClassification.OPTIONAL,
                          description="Approved quantity (defaults to requested quantity)"),
            FieldMetadata("reject_reason", FieldClassification.OPTIONAL),
            FieldMetadata("notes", FieldClassification.OPTIONAL),
        ],
    ),

    "approve_shopping_list": ActionDefinition(
        action_id="approve_shopping_list",
        label="Approve Entire List",
        endpoint="/v1/actions/execute",
        handler_type=HandlerType.INTERNAL,
        method="POST",
        allowed_roles=["chief_engineer", "chief_officer", "captain", "manager"],
        ...
        domain="shopping_list",
        variant=ActionVariant.MUTATE,
        search_keywords=["approve", "shopping", "list", "hod", "final"],
        field_metadata=[
            FieldMetadata("yacht_id", FieldClassification.CONTEXT),
            FieldMetadata("shopping_list_id", FieldClassification.REQUIRED, description="Shopping list to approve"),
        ],
    ),
    ...
    "add_shopping_list_photo": ActionDefinition(
        ...
        domain="shopping_list",
        variant=ActionVariant.MUTATE,
        search_keywords=["photo", "image", "attach", "shopping", "list", "picture"],
        field_metadata=[
            FieldMetadata("yacht_id", FieldClassification.CONTEXT),
            FieldMetadata("item_id", FieldClassification.REQUIRED, description="Shopping list item ID"),
    ...
    # ========================================================================
    # These map frontend action_ids to existing backend handlers.

    "add_certificate_note": ActionDefinition(
        action_id="add_certificate_note",
        label="Add Certificate Note",
        endpoint="/v1/actions/execute",
        handler_type=HandlerType.INTERNAL,
        method="POST",
    ...
    "add_part_note": ActionDefinition(
        action_id="add_part_note",
        label="Add Part Note",
        endpoint="/v1/actions/execute",
        handler_type=HandlerType.INTERNAL,
        method="POST",
    ...
    "add_po_note": ActionDefinition(
        action_id="add_po_note",
        label="Add PO Note",
        endpoint="/v1/actions/execute",
        handler_type=HandlerType.INTERNAL,
        method="POST",
    ...
    "add_warranty_note": ActionDefinition(
        action_id="add_warranty_note",
        label="Add Warranty Note",
        endpoint="/v1/actions/execute",
        handler_type=HandlerType.INTERNAL,
        method="POST",
        allowed_roles=["chief_engineer", "chief_officer", "captain", "manager"],
    ...
    "apply_template": ActionDefinition(
    ...
    "approve_list": ActionDefinition(
        action_id="approve_list",
        label="Approve Shopping List Item",
        endpoint="/v1/actions/execute",
        handler_type=HandlerType.INTERNAL,
        method="POST",
    ...
    "add_list_item": ActionDefinition(
        action_id="add_list_item",
        label="Add to Shopping List",
        endpoint="/v1/actions/execute",
        handler_type=HandlerType.INTERNAL,
        method="POST",
    ...
    "sign_handover": ActionDefinition(
        action_id="sign_handover",
        label="Sign Handover",
        endpoint="/v1/actions/execute",
        handler_type=HandlerType.INTERNAL,
        method="POST",
    ...
    "file_warranty_claim": ActionDefinition(
        action_id="file_warranty_claim",
        label="File Warranty Claim",
        endpoint="/v1/actions/execute",
        handler_type=HandlerType.INTERNAL,
        method="POST",
        allowed_roles=["chief_engineer", "chief_officer", "captain", "manager"],
        required_fields=["yacht_id", "title", "vendor_name"],
        domain="warranty",
        variant=ActionVariant.MUTATE,
        search_keywords=["warranty", "claim", "file", "vendor", "defect", "return"],
        field_metadata=[
            FieldMetadata("yacht_id", FieldClassification.CONTEXT),
            FieldMetadata("title", FieldClassification.REQUIRED, description="Claim title"),
            FieldMetadata("description", FieldClassification.OPTIONAL, description="Detailed description of the warranty issue"),
            FieldMetadata("claim_type", FieldClassification.OPTIONAL,
                          options=["manufacturer_defect", "premature_failure", "incorrect_part", "damage_in_transit", "other"],
                          description="Type of warranty claim"),
            FieldMetadata("vendor_name", FieldClassification.REQUIRED, description="Vendor / manufacturer name"),
            FieldMetadata("equipment_id", FieldClassification.OPTIONAL,
                          lookup_required=True,
                          description="Affected equipment"),
            FieldMetadata("part_number", FieldClassification.OPTIONAL, description="Part number"),
            FieldMetadata("serial_number", FieldClassification.OPTIONAL, description="Serial number"),
            FieldMetadata("purchase_date", FieldClassification.OPTIONAL, description="Original purchase date"),
            FieldMetadata("warranty_expiry", FieldClassification.OPTIONAL, description="Warranty expiry date"),
            FieldMetadata("claimed_amount", FieldClassification.OPTIONAL, description="Claimed amount"),
    ...
    "investigate_fault": ActionDefinition(
        action_id="investigate_fault",
        label="Investigate Fault",
        endpoint="/v1/actions/execute",
        handler_type=HandlerType.INTERNAL,
        method="POST",
        allowed_roles=["chief_engineer", "chief_officer", "captain"],
    ...
    "update_part_details": ActionDefinition(
        action_id="update_part_details",
    ...
    # ========================================================================
    # TASK 3: ORPHAN HANDLER REGISTRATIONS
    # ========================================================================
    # These handlers already exist in INTERNAL_HANDLERS but had no registry
    # entry, so get_available_actions() could never return them.

    # -- P3 Read-Only Handlers --
    "view_document": ActionDefinition(
    ...
    "view_related_documents": ActionDefinition(
        action_id="view_related_documents",
    ...
    "view_document_section": ActionDefinition(
        action_id="view_document_section",
        label="View Document Section",
        endpoint="/v1/actions/execute",
        handler_type=HandlerType.INTERNAL,
        method="POST",
        allowed_roles=["crew", "chief_engineer", "chief_officer", "captain", "manager"],
    ...
    "view_work_order_history": ActionDefinition(
        action_id="view_work_order_history",
        label="View Work Order History",
        endpoint="/v1/actions/execute",
        handler_type=HandlerType.INTERNAL,
        method="POST",
        allowed_roles=["crew", "chief_engineer", "chief_officer", "captain", "manager"],
    ...
    "view_checklist": ActionDefinition(
    ...
    "view_equipment_details": ActionDefinition(
        action_id="view_equipment_details",
    ...
    "view_equipment_history": ActionDefinition(
        action_id="view_equipment_history",
    ...
    "view_equipment": ActionDefinition(
    ...
    "view_maintenance_history": ActionDefinition(
    ...
    "view_fleet_summary": ActionDefinition(
        action_id="view_fleet_summary",
        label="View Fleet Summary",
        endpoint="/v1/actions/execute",
        handler_type=HandlerType.INTERNAL,
        method="POST",
        allowed_roles=["captain", "manager"],
    ...
    "export_fleet_summary": ActionDefinition(
    ...
    "request_predictive_insight": ActionDefinition(
        action_id="request_predictive_insight",
        label="Request Predictive Insight",
        endpoint="/v1/actions/execute",
        handler_type=HandlerType.INTERNAL,
        method="POST",
        allowed_roles=["chief_engineer", "chief_officer", "captain", "manager"],
    ...
    "view_part_stock": ActionDefinition(
        action_id="view_part_stock",
        label="View Part Stock",
        endpoint="/v1/actions/execute",
        handler_type=HandlerType.INTERNAL,
        method="POST",
        allowed_roles=["crew", "chief_engineer", "chief_officer", "captain", "manager"],
    ...
    "view_part_location": ActionDefinition(
        action_id="view_part_location",
        label="View Part Location",
        endpoint="/v1/actions/execute",
        handler_type=HandlerType.INTERNAL,
        method="POST",
        allowed_roles=["crew", "chief_engineer", "chief_officer", "captain", "manager"],
    ...
    "view_part_usage": ActionDefinition(
        action_id="view_part_usage",
        label="View Part Usage",
        endpoint="/v1/actions/execute",
        handler_type=HandlerType.INTERNAL,
        method="POST",
        allowed_roles=["crew", "chief_engineer", "chief_officer", "captain", "manager"],
    ...
    "scan_part_barcode": ActionDefinition(
    ...
    "view_linked_equipment": ActionDefinition(
        action_id="view_linked_equipment",
        label="View Linked Equipment",
        endpoint="/v1/actions/execute",
        handler_type=HandlerType.INTERNAL,
        method="POST",
        allowed_roles=["crew", "chief_engineer", "chief_officer", "captain", "manager"],
    ...
    "view_smart_summary": ActionDefinition(
        action_id="view_smart_summary",
        label="View Smart Summary",
        endpoint="/v1/actions/execute",
        handler_type=HandlerType.INTERNAL,
        method="POST",
        allowed_roles=["chief_engineer", "chief_officer", "captain", "manager"],
    ...
    "approve_purchase": ActionDefinition(
    ...
    "add_checklist_note": ActionDefinition(
    ...
    "add_checklist_photo": ActionDefinition(
        action_id="add_checklist_photo",
        label="Add Checklist Photo",
        endpoint="/v1/actions/execute",
        handler_type=HandlerType.INTERNAL,
        method="POST",
        allowed_roles=["crew", "chief_engineer", "chief_officer", "captain", "manager"],
    ...
    "add_work_order_note": ActionDefinition(
    ...
    "record_voice_note": ActionDefinition(
    ...
    "regenerate_handover_summary": ActionDefinition(
        action_id="regenerate_handover_summary",
        label="Regenerate Handover Summary",
        endpoint="/v1/actions/execute",
        handler_type=HandlerType.INTERNAL,
        method="POST",
        allowed_roles=["chief_engineer", "chief_officer", "captain", "manager"],
    ...
    "tag_for_survey": ActionDefinition(
    ...
    "update_purchase_status": ActionDefinition(
        action_id="update_purchase_status",
        label="Update Purchase Status",
        endpoint="/v1/actions/execute",
        handler_type=HandlerType.INTERNAL,
        method="POST",
        allowed_roles=["purser", "chief_engineer", "chief_officer", "chief_steward", "captain", "manager"],
    ...
    # -- Legacy/Original handlers now registered --
    ...
    "open_document": ActionDefinition(
        ...
        method="POST",
        allowed_roles=["crew", "chief_engineer", "chief_officer", "captain", "manager"],
        required_fields=["yacht_id", "storage_path"],
        domain="documents",
        variant=ActionVariant.READ,
    ),
    ...
    "create_work_order": ActionDefinition(
        ...
        field_metadata=[
            ...
            FieldMetadata("equipment_id", FieldClassification.OPTIONAL,
                          lookup_required=True,
                          description="Linked equipment (search equipment by name)"),
            FieldMetadata("assigned_to", FieldClassification.OPTIONAL,
                          lookup_required=True,
                          description="Assigned crew member"),
            FieldMetadata("due_date", FieldClassification.OPTIONAL, description="Due date"),
            FieldMetadata("estimated_duration_minutes", FieldClassification.OPTIONAL,
                          description="Estimated duration in minutes"),
            FieldMetadata("fault_id", FieldClassification.OPTIONAL,
                          lookup_required=True,
    ...
    "add_to_shopping_list": ActionDefinition(
        ...
        domain="shopping_list",
        variant=ActionVariant.MUTATE,
        search_keywords=["shopping", "list", "add", "request", "order", "buy", "need"],
        field_metadata=[
            FieldMetadata("yacht_id", FieldClassification.CONTEXT),
            FieldMetadata("part_id", FieldClassification.REQUIRED,
                          lookup_required=True,
                          description="Part to add to shopping list"),
            FieldMetadata("quantity_requested", FieldClassification.REQUIRED,
                          description="Quantity needed"),
            FieldMetadata("shopping_list_id", FieldClassification.OPTIONAL,
                          description="Target shopping list document (leave blank to create a floating item)"),
            FieldMetadata("urgency", FieldClassification.OPTIONAL,
                          options=["low", "normal", "high", "critical"],
            ...
            FieldMetadata("required_by_date", FieldClassification.OPTIONAL,
                          description="Date needed by"),
            FieldMetadata("source_notes", FieldClassification.OPTIONAL,
                          description="Notes on why this is needed"),
            FieldMetadata("source_work_order_id", FieldClassification.OPTIONAL,
                          lookup_required=True,
    ...
    # ========================================================================
    # All map to soft_delete_entity handler. SIGNED, HOD/captain access.

    "delete_work_order": ActionDefinition(
        action_id="delete_work_order",
    ...
    "archive_fault": ActionDefinition(
        action_id="archive_fault",
        label="Archive Fault",
        endpoint="/v1/actions/execute",
        handler_type=HandlerType.INTERNAL,
        method="POST",
    ...
    "suspend_certificate": ActionDefinition(
    ...
    # ── Phase 4 native PO handlers (submit → approve → receive lifecycle) ──
    "submit_purchase_order": ActionDefinition(
        action_id="submit_purchase_order",
    ...
    "approve_purchase_order": ActionDefinition(
    ...
    "mark_po_received": ActionDefinition(
        action_id="mark_po_received",
    ...
    "archive_document": ActionDefinition(
    ...
    "archive_warranty": ActionDefinition(
        action_id="archive_warranty",
        label="Archive Warranty",
        endpoint="/v1/actions/execute",
        handler_type=HandlerType.INTERNAL,
        method="POST",
        allowed_roles=["chief_engineer", "chief_officer", "captain", "manager"],
    ...
    "void_warranty": ActionDefinition(
        action_id="void_warranty",
        label="Void Warranty",
        endpoint="/v1/actions/execute",
        handler_type=HandlerType.INTERNAL,
        method="POST",
    ...
    "archive_list": ActionDefinition(
        action_id="archive_list",
        label="Archive Shopping List",
        endpoint="/v1/actions/execute",
        handler_type=HandlerType.INTERNAL,
        method="POST",
        allowed_roles=["chief_engineer", "chief_officer", "captain", "manager"],
    ...
    "archive_handover": ActionDefinition(
        action_id="archive_handover",
        label="Archive Handover",
        endpoint="/v1/actions/execute",
        handler_type=HandlerType.INTERNAL,
        method="POST",
        allowed_roles=["chief_engineer", "chief_officer", "captain", "manager"],
    ...
    "delete_handover": ActionDefinition(
        action_id="delete_handover",
        label="Delete Handover",
        endpoint="/v1/actions/execute",
        handler_type=HandlerType.INTERNAL,
        method="POST",
        allowed_roles=["chief_engineer", "chief_officer", "captain", "manager"],
    ...
    # ========================================================================
    # TASK 5: STUB REGISTRATIONS (not yet implemented)
    # ========================================================================

    "renew_certificate": ActionDefinition(
    ...
    "confirm_receiving": ActionDefinition(
        action_id="confirm_receiving",
    ...
    "convert_to_po": ActionDefinition(
        action_id="convert_to_po",
    ...
    "submit_list": ActionDefinition(
        action_id="submit_list",
        label="Submit Shopping List",
        endpoint="/v1/actions/execute",
        handler_type=HandlerType.INTERNAL,
        method="POST",
        allowed_roles=["crew", "chief_engineer", "chief_officer", "captain", "manager"],
    ...
    "flag_discrepancy": ActionDefinition(
        action_id="flag_discrepancy",
        label="Flag Discrepancy",
        endpoint="/v1/actions/execute",
        handler_type=HandlerType.INTERNAL,
        method="POST",
        allowed_roles=["crew", "deckhand", "steward", "engineer", "eto", "chief_engineer", "chief_officer", "chief_steward", "purser", "captain", "manager"],
        required_fields=["yacht_id", "receiving_id", "discrepancy_type", "description"],
        domain="receiving",
        variant=ActionVariant.MUTATE,
        search_keywords=["flag", "discrepancy", "missing", "damaged", "wrong", "partial", "issue"],
        field_metadata=[
            FieldMetadata("yacht_id", FieldClassification.CONTEXT),
            FieldMetadata("receiving_id", FieldClassification.REQUIRED, description="Receiving record ID"),
            FieldMetadata("discrepancy_type", FieldClassification.REQUIRED,
                          options=["missing", "damaged", "wrong_item", "partial"],
                          description="Type of discrepancy"),
            FieldMetadata("description", FieldClassification.REQUIRED, description="Details of the discrepancy"),
            FieldMetadata("affected_items", FieldClassification.OPTIONAL, description="Array of affected item descriptions"),
        ],
    ),
}
