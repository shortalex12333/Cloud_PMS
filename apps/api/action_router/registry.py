...
ACTION_REGISTRY: Dict[str, ActionDefinition] = {
    ...
    "add_to_handover": ActionDefinition(
        ...
        handler_type=HandlerType.INTERNAL,
        method="POST",
        allowed_roles=["crew", "engineer", "eto", "chief_engineer", "chief_officer", "captain", "manager"],
    ...
    "track_po_delivery": ActionDefinition(
        action_id="track_po_delivery",
        label="Track PO Delivery",
        endpoint="/v1/actions/execute",
        handler_type=HandlerType.INTERNAL,
        method="POST",
        allowed_roles=["chief_engineer", "chief_officer", "captain", "manager"],
    ...
    "track_delivery": ActionDefinition(
