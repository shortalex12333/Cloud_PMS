#!/bin/bash
# Test POST /v2/search to verify context + actions are included (crew role)
...
echo "Testing POST /v2/search with CREW role (parts query)"
echo "=========================================================================="
...
echo "- actions: 2 items (crew only gets READ actions)"
echo "  - check_stock_level"
echo "  - view_part_details"
