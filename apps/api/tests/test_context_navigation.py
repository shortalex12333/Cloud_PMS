...
def test_yacht(supabase):
    ...
    try:
        # Try to insert, ignore if exists (will violate unique constraint)
        supabase.table("yachts").upsert(yacht_data, on_conflict="id").execute()
    except Exception as e:
        # If it fails for any reason other than already exists, that's OK for tests
        pass
    yield TEST_YACHT_ID
...
class TestCreateContext:
    ...
    def test_create_context_inserts_row(self, supabase, test_yacht):
    ...
    def test_create_context_writes_audit_event(self, supabase, test_yacht):
...
class TestUpdateAnchor:
    ...
    def test_update_anchor_modifies_row(self, supabase, test_yacht):
    ...
    def test_update_anchor_writes_audit_event(self, supabase, test_yacht):
...
class TestGetRelated:
    ...
    def test_related_does_not_write_audit_event(self, supabase, test_yacht):
    ...
    def test_related_returns_fixed_domain_order(self, supabase, test_yacht):
...
class TestAddRelation:
    ...
    def test_add_relation_creates_row(self, supabase, test_yacht):
    ...
    def test_add_relation_writes_audit_event(self, supabase, test_yacht):
...
class TestEndContext:
    ...
    def test_end_context_sets_ended_at(self, supabase, test_yacht):
    ...
    def test_end_context_writes_audit_event(self, supabase, test_yacht):
