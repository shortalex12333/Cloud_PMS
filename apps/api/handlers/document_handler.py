...
Block 3 (L5037-5078): upload_document, update_document, delete_document, add_document_tags,
    get_document_url, list_documents — delegates to get_document_handlers() in this module.
"""
import logging
import uuid
...
# ============================================================================
# Document Lens V2 actions (L5037-5078) — delegate to get_document_handlers()
# ============================================================================
...
async def _delegate_to_doc_handler(
    ...
    """Call the named document handler using get_document_handlers (this module)."""
...
# ============================================================================
# get_document_handlers — single source of truth for document action adapters.
# Returns a flat dict of {action_id: async_fn(**params)} adapters backed by
# a fresh DocumentHandlers instance scoped to supabase_client.
# (document_handlers.py was merged into this file — 2026-04-27)
# ============================================================================

def get_document_handlers(supabase_client) -> dict:
    """Return document handler adapters keyed by action_id.

    This is the single source of truth after the document_handlers.py merge.
    All adapters accept flat **params with at minimum yacht_id and user_id.
    """
    handlers = DocumentHandlers(supabase_client)

    async def _get_url(**params):
