...
@secure_action decorator for handler security enforcement.
...
def validate_entity_ownership(
    ...
    Raises:
        OwnershipValidationError: If entity not found or not owned (returns 404)
    """
    ...
    try:
        ...
        raise OwnershipValidationError(e.entity_type, e.entity_id)
...
def is_secured_handler(func: Callable) -> bool:
    ...
    Used by CI contract tests and router startup to verify all handlers are secured.
...
def get_standard_error_codes() -> Dict[str, Dict[str, Any]]:
    ...
    return {
        ...
        "TWO_PERSON_RULE": {"status_code": 403, "message": "Requires different approver"},
