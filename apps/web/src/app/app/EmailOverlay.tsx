  ...
  const overlayContent = (
    <>
      ...
      <div
        ...
        className="fixed inset-y-0 left-0 z-[1001] w-[95vw] max-w-[1400px] bg-surface-base border-r border-surface-border transform transition-transform duration-300 ease-out translate-x-0"
      >
        <EmailSurface
          className="h-full"
