  ...
  ({ className, onCheckedChange, checked, ...props }, ref) => {
    ...
    return (
      <div className="relative inline-flex items-center">
        ...
        <div
          className={cn(
            "h-4 w-4 shrink-0 rounded-xs border border-surface-border ring-offset-background",
            ...
            "peer-checked:bg-brand-interactive peer-checked:border-brand-interactive peer-checked:text-txt-primary",
