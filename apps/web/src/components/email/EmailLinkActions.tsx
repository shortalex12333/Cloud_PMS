      ...
      <div className="flex items-center gap-1">
        ...
        {isSuggested && (
          <button
            ...
            className={cn(
              'inline-flex items-center gap-1 px-2 py-1 text-[12px] rounded transition-colors',
        ...
        <button
          ...
          className="inline-flex items-center gap-1 px-2 py-1 text-[12px] rounded transition-colors text-zinc-600 hover:bg-zinc-100 dark:text-zinc-400 dark:hover:bg-zinc-800"
        >
        ...
        <button
          ...
          className="inline-flex items-center gap-1 px-2 py-1 text-[12px] rounded transition-colors text-red-600 hover:bg-red-50 dark:text-red-400 dark:hover:bg-red-900/20"
        >
