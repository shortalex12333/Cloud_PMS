    ...
    return (
      <div className="py-4 px-3 bg-red-50 dark:bg-red-900/20 rounded">
        <div className="flex items-start gap-2">
          ...
          <div>
            <p className="typo-meta font-medium text-red-700 dark:text-red-400">
              Can&apos;t retrieve original right now
            </p>
            <p className="typo-meta text-red-600 dark:text-red-500 mt-0.5">
              Reason: {error instanceof Error ? error.message : 'Unknown error'}
            </p>
            <button
              onClick={onClose}
              className="typo-meta text-red-500 hover:text-red-600 mt-2"
            >
              Dismiss
            </button>
          </div>
