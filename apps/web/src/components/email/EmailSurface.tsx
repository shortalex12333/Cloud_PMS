    ...
    >
      ...
      <div className="px-4 py-3 border-b border-surface-border">
        <div className="flex items-center gap-4">
          ...
          <div className="flex-1 flex items-center gap-2 px-3 py-2 rounded-lg bg-surface-primary border border-surface-border focus-within:border-brand-interactive/50">
            ...
            <input
              ...
              className="flex-1 bg-transparent text-[13px] text-txt-primary placeholder:text-txt-tertiary outline-none"
            />
            {searchQuery && (
          ...
          <div className="flex items-center gap-1 text-[11px]">
            <button
              ...
              className={cn(
                ...
                filter === 'all' ? 'bg-surface-hover text-txt-primary' : 'text-txt-secondary hover:text-txt-primary'
              )}
            >
              All
            </button>
            <button
              ...
              className={cn(
                'px-2 py-1 rounded transition-colors',
                filter === 'linked' ? 'bg-surface-hover text-txt-primary' : 'text-txt-secondary hover:text-txt-primary'
              )}
            >
              Linked
            </button>
            <button
              ...
              className={cn(
                'px-2 py-1 rounded transition-colors',
                filter === 'unlinked' ? 'bg-surface-hover text-txt-primary' : 'text-txt-secondary hover:text-txt-primary'
              )}
            >
              Unlinked
            </button>
      ...
      <div className="flex-1 flex overflow-hidden">
        {/* LEFT: Results */}
        <div ref={listRef} className="w-[400px] flex-shrink-0 border-r border-surface-border overflow-y-auto">
          {displayLoading && (
    ...
    >
      ...
      <div className="flex-1 min-w-0">
        <div className="flex items-center justify-between gap-2">
          <span className={cn(
            'text-[13px] truncate',
            isUnread ? 'font-semibold text-txt-primary' : 'font-normal text-txt-secondary'
          )}>
            {sender}
          </span>
          {/* Linked indicator */}
        ...
        <p className={cn(
          ...
          isUnread ? 'font-medium text-txt-primary' : 'font-normal text-txt-tertiary'
        )}>
          {subject}
        </p>
        {snippet && (
          ...
          {linkedItems.length > 0 ? (
            ...
            <div className="py-4">
              ...
              <div className="flex gap-2">
                <button
                  onClick={onLinkEmail}
                  className="px-4 py-2 rounded bg-brand-interactive text-txt-primary text-[12px] font-medium hover:bg-brand-interactive/90 transition-colors"
                >
                  Link...
                </button>
                <button
                  onClick={onCreateWorkOrder}
                  className="px-4 py-2 rounded bg-surface-hover text-txt-primary text-[12px] font-medium hover:bg-surface-hover transition-colors"
                >
                  Create Work Order
                </button>
              </div>
          ...
          {!contentLoading && content && (
            <>
              ...
              <div className="flex items-center gap-4 mb-4 pb-4 border-b border-surface-border">
                <button className="text-[12px] text-txt-secondary hover:text-txt-primary transition-colors">
                  Reply
                </button>
                <button className="text-[12px] text-txt-secondary hover:text-txt-primary transition-colors">
                  Reply All
              ...
              {showBody && (
                <div className="text-[13px] text-txt-primary leading-relaxed mb-4">
                  {content.body?.contentType === 'html' ? (
                    <div
                      className="prose prose-invert prose-sm max-w-none
                        ...
                        [&_table]:border-collapse [&_td]:border [&_td]:border-surface-border [&_td]:p-2"
                    ...
                    <div className="mt-2 space-y-1">
                      {attachments.map((att) => (
                        <button
                          ...
                          className="w-full flex items-center gap-2 px-3 py-2 rounded bg-surface-primary hover:bg-surface-hover transition-colors text-left"
                        >
...
function LinkedItemRow({ item }: { item: ThreadLink }) {
  ...
  return (
    <button className="w-full flex items-center gap-3 px-3 py-2.5 rounded bg-surface-primary hover:bg-surface-hover transition-colors text-left group">
