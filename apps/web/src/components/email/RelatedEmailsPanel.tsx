  ...
  return (
    <div className={cn('section-container', className)}>
      ...
      <button
        ...
        className="w-full flex items-center justify-between p-3 hover:bg-zinc-50 dark:hover:bg-surface-active transition-colors"
      >
...
function ThreadItem({ thread, isSelected, onClick, objectType, objectId }: ThreadItemProps) {
  return (
    <div className="p-3 hover:bg-zinc-50 dark:hover:bg-surface-active transition-colors">
      <button
        onClick={onClick}
