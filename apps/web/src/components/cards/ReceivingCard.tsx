    ...
    switch (status) {
      ...
      default:
        return {
          label: 'Draft',
          icon: Clock,
          color: 'text-txt-tertiary bg-surface-hover border-surface-border',
        };
    }
  };
      ...
      <div className="flex items-start gap-3">
        ...
        <div className="flex-1 min-w-0">
          ...
          {receiving.po_number && receiving.po_number !== receiving.vendor_reference && (
            <div className="flex items-center gap-1.5 text-sm text-txt-tertiary mb-1">
          ...
          {formatTotal(receiving.total, receiving.currency) && (
            <div className="text-sm font-medium text-txt-primary mt-2">
          ...
          {/* Notes */}
          {receiving.notes && (
            <p className="text-sm text-txt-tertiary mt-2 line-clamp-2">
              {receiving.notes}
            </p>
          )}
