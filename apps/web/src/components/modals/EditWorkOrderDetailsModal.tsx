...
export function EditWorkOrderDetailsModal({
  ...
  const getPriorityColor = (prio: string) => {
    switch (prio) {
      ...
      case 'routine':
        return 'text-brand-interactive bg-brand-interactive/10 border-brand-interactive/20';
      default:
      ...
      <DialogContent className="max-w-3xl max-h-[90vh] overflow-y-auto">
        <DialogHeader>
          <DialogTitle className="flex items-center gap-2">
            <Edit className="h-5 w-5 text-brand-interactive" />
              ...
              <SelectContent>
                <SelectItem value="routine">
                  <span className="flex items-center gap-2">
                    <span className="h-2 w-2 rounded-full bg-brand-interactive" />
          ...
          {hasChanges && !cannotEdit && (
            <div className="p-4 bg-brand-interactive/10 border border-brand-interactive/20 rounded-lg">
              <div className="flex items-start gap-3">
                ...
                <div>
                  <p className="font-semibold text-brand-interactive">Changes Detected</p>
                  ...
                  <Button
                    ...
                    className="p-0 h-auto text-brand-interactive"
                  >
                    {showChanges ? 'Hide' : 'Show'} changes
                  </Button>
                  {showChanges && (
                    <ul className="mt-2 text-sm text-brand-interactive space-y-1">
