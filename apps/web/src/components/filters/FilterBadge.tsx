...
export function FilterBadge({ label, value, onRemove, className }: FilterBadgeProps) {
  return (
    <div
      className={cn(
        'inline-flex items-center gap-1.5 px-3 py-1 rounded-md border border-[var(--surface-border)] bg-primary/10 typo-body',
        className
      )}
    >
      ...
      <button
        onClick={onRemove}
        className="ml-1 hover:bg-primary/20 rounded-lg p-0.5 transition-colors"
