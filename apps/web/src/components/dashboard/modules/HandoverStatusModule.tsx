    ...
    <ModuleContainer
      ...
      collapsedContent={
        <div className="flex items-center gap-3">
          ...
          <span className="text-xs text-zinc-500">{completeSections}/{totalSections} sections</span>
        </div>
      }
      className={className}
    >
      {isLoading ? (
        ...
        <>
          ...
          <div className="flex items-center justify-between mb-4 pb-3 border-b border-zinc-200/60 dark:border-zinc-700/60">
            <div>
              <p className="text-xs text-zinc-500 dark:text-zinc-400">Next Handover</p>
              <p className="text-sm font-medium text-zinc-700 dark:text-zinc-200">
                {handover.nextHandover}
              </p>
            </div>
            <div className="text-right">
              <p className="text-xs text-zinc-500 dark:text-zinc-400">Assignment</p>
              <p className="text-sm font-medium text-zinc-700 dark:text-zinc-200">
                {handover.assignedTo}
              </p>
            </div>
