...
const nextConfig = {
  ...
  async headers() {
    ...
    const localDevUrls = (isDev || isLocalApi)
      ? `http://127.0.0.1:54321 http://localhost:54321 http://127.0.0.1:8000 http://localhost:8000 ${isLocalApi && apiUrl ? apiUrl + ' ' : ''}`
      : '';
        ...
        headers: [
          {
            ...
            value: [
              ...
              `connect-src 'self' ${localDevUrls}https://qvzmkaamzaqxpzbewjxe.supabase.co https://vzsohavtuotocgrfkfyd.supabase.co https://backend.celeste7.ai https://pipeline-core.int.celeste7.ai https://api.celeste7.ai https://app.celeste7.ai https://auth.celeste7.ai https://handover-export.onrender.com`,
            ].join('; '),
          },
        ],
      },
