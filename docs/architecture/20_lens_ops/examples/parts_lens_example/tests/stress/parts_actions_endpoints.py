...
def stress_test_list(jwt_token: str, concurrency: int) -> List[Dict[str, Any]]:
    ...
    """
    print(f"\nStress Testing: GET /v1/actions/list?domain=parts")
    ...
    with ThreadPoolExecutor(max_workers=concurrency) as executor:
        futures = [
            executor.submit(make_request, jwt_token, f"/v1/actions/list?domain=parts")
...
def stress_test_execute(jwt_token: str, concurrency: int) -> List[Dict[str, Any]]:
    ...
    payload = {
        "action": "view_part_detail",  # e.g., "view_fault_detail"
        "context": {"yacht_id": "85fe1119-b04c-41ac-80f1-829d23322598"},
        "payload": {
            "yacht_id": "85fe1119-b04c-41ac-80f1-829d23322598",
            "part_id": "00000000-0000-0000-0000-000000000000"  # Fake ID
        }
    }
