...
# Generated with iat=1769587720 (2026-01-28 08:08 UTC, 6 hours before generation)
# Issue: Render server clock is significantly behind GitHub Actions clock
# Solution: Set iat 6 hours in past to handle clock skew
# TODO: Replace with proper secret management system once clock skew resolved
CREW_JWT = os.getenv(
    "CREW_JWT",
    "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9..wEcrocpb_VWuk-IxSTx2fwzkwAdcQgNORBb0UyIttek"
)
HOD_JWT = os.getenv(
    "HOD_JWT",
    "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9..cAAl-Fp6Wrh81VYw2s3CX2KuxoSQYgt5nYpu7-nmatE"
)
CAPTAIN_JWT = os.getenv(
    "CAPTAIN_JWT",
    "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9..vmJb35r4XDQ4eRHll1DymdZjQ7347TM8isjK0KN1Lsg"
)
