...
-- =============================================================================
-- NOTE: This schema reflects the ACTUAL production database as of 2026-01-23
-- Previous version defined fault_number, reported_by, reported_at which were never applied
-- Production uses fault_code, detected_at, and includes soft delete pattern
-- =============================================================================
