#!/usr/bin/env python3
"""
{LENS_ID} Health Worker (Render Background Service)
...
FEATURE_FLAGS = [
    "{FEATURE_FLAG_1}",  # e.g., "FAULT_LENS_V1_ENABLED"
    "{FEATURE_FLAG_2}",  # e.g., "FAULT_LENS_SUGGESTIONS_ENABLED"
    "{FEATURE_FLAG_3}",  # e.g., "FAULT_LENS_SIGNED_ACTIONS_ENABLED"
]

# Test user (HOD with chief_engineer role)
TEST_USER_ID = "{TEST_USER_ID}"  # e.g., "05a488fd-e099-4d18-bf86-d87afba4fcdf"
TEST_USER_EMAIL = "{TEST_USER_EMAIL}"  # e.g., "hod.test@alex-short.com"
