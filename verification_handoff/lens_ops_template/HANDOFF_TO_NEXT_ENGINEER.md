...
```
verification_handoff/lens_ops_template/          ← YOU ARE HERE
│
...
# Apply to staging
psql $STAGING_DB_URL < verification_handoff/lens_ops_template/migrations/ops_health_tables.sql
...
python3 verification_handoff/lens_ops_template/create_lens_ops_template.py \
  --lens-id faults \
  --domain faults \
...
**Location:** `verification_handoff/lens_ops_template/templates/`
...
**Location:** `verification_handoff/lens_ops_template/create_lens_ops_template.py`
...
**Location:** `verification_handoff/lens_ops_template/migrations/ops_health_tables.sql`
...
**Location:** `verification_handoff/lens_ops_template/docs/`
...
**Documentation:** `verification_handoff/lens_ops_template/docs/README.md`
...
**Generator Help:**
```bash
python3 verification_handoff/lens_ops_template/create_lens_ops_template.py --help
```
